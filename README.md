...
YouTubeチャンネルのライブアーカイブをキューに保存し、古い順または新しい順で連続再生するChrome拡張です。
...
3. 「ライブアーカイブを取り込む」を押す
4. 自動で「ライブ」タブへ移動して全件を取得し、先頭から連続再生を始める

現在はライブアーカイブ専用です。動画タブとShortsタブは取り込みません。また、1チャンネルにつき1つのキューを保存します。

メニュー右上の「×」を押すと、右下の拡張機能アイコンへ最小化できます。アイコンを押すとメニューを再表示します。
